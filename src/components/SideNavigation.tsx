...
const SideNavigation: React.FC = () => {
  return (
    <div className="fixed left-0 top-0 h-screen z-40 flex items-start">
      <div className="bg-white rounded-r-3xl shadow-lg p-4 flex flex-col items-center space-y-6 pt-20">
